...
INSERT INTO "new_Student" ("acudienteEmail", "acudienteNombre", "acudienteOcupacion", "acudienteTelefono", "address", "admissionNo", "bloodGroup", "certificado", "classId", "createdAt", "dateOfBirth", "email", "enrollmentDate", "eps", "exalumno", "fatherEmail", "fatherName", "fatherOccupation", "fatherPhone", "fechaExpedicion", "fechaSalida", "gender", "id", "lastName", "lugarExpedicion", "lugarNacimiento", "motherName", "motherPhone", "name", "nationality", "numeroContrato", "numeroCotizacion", "numeroIdentificacion", "numeroPoliza", "organizationId", "phone", "photo", "religion", "responsableTipo", "sectionId", "sedeId", "status", "tipoIdentificacion", "tipoSalud", "updatedAt", "userId") SELECT "acudienteEmail", "acudienteNombre", "acudienteOcupacion", "acudienteTelefono", "address", "admissionNo", "bloodGroup", "certificado", "classId", "createdAt", "dateOfBirth", "email", "enrollmentDate", "eps", "exalumno", "fatherEmail", "fatherName", "fatherOccupation", "fatherPhone", "fechaExpedicion", "fechaSalida", "gender", "id", "lastName", "lugarExpedicion", "lugarNacimiento", "motherName", "motherPhone", "name", "nationality", "numeroContrato", "numeroCotizacion", "numeroIdentificacion", "numeroPoliza", "organizationId", "phone", "photo", "religion", "responsableTipo", "sectionId", "sedeId", "status", "tipoIdentificacion", "tipoSalud", "updatedAt", "userId" FROM "Student";
DROP TABLE "Student";
